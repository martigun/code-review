...
<div>
	<form method="post" action="Passenger_Update_Code.php"> 

		<fieldset>
			<legend>Update Passenger Name</legend>
			<p>Passenger ID
						<select name="PsgrID">
<?php
...
?>
				...
				<p>First Name Update: <input type="text" name="FirstName" /></p>
				<p>Last Name Update: <input type="text" name="LastName" /></p>
		</fieldset>
